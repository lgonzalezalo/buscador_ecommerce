...
from indexado.indice import load_index, embed_query, cosine_similarity, format_categoria
...
from faq.faq import cargar_faq, construir_indice_faq, responder_faq, RUTA_FAQ_POR_DEFECTO
...
def main():
    ...
    if intencion == "faq":
        ...
        mejor, similitud = responder_faq(args.query, faq_items, faq_vectors)
